...
description: >
  ...
  about {X}", "MADR for {topic}", "/sdd:decide-adr {slug} {title}", "create an ADR for the decision",
  "document the decision", "ADR for {topic}". Confirms the decision is ADR-worthy via the
